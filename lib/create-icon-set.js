...
function createIconSet(glyphMap : Object, fontFamily : string, fontFile : string) : Function {
  ...
  var Icon = React.createClass({
    ...
    render: function() {
      ...
      return (<Text allowFontScaling={false} {...props}>{glyph}{this.props.children}</Text>);
    }
  });
  ...
  var IconButton = React.createClass({
    ...
    render: function() {
      ...
      if(isString(children)) {
        children = (<Text allowFontScaling={false} style={[styles.text, colorStyle]}>{children}</Text>);
      }
